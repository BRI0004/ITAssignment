...
function love.keypressed(key)
   ...
   elseif key == "5" or key == "kp5" then
    ...
    elseif selected and key == "return" or key == "kpenter" then
...
function love.draw()
	...
	love.graphics.print("C - Change Colors   V - SetFont "..(isverdana and "Verdana size 16" or "Default").."   M - Add 10.000 itens",10,550*sizeh,0,1.2*sizew,1.2*sizeh)
	end
	if selected then
