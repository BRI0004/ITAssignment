...
gw = 800, -- first Width captured to resize, do not works if you confugured(conf.lua) in fullscreen (or set gw)
gh = 600, -- first Height captured to resize, do not works if you confugured(conf.lua) in fullscreen (or set gh)
...
bordercolor={255,255,255}, -- border color RGB (table)
