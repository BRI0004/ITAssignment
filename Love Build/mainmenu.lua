  ...
  state = {
    ...
    --      state.mainmenu.gui:feedback("Free Mode Selected")
      ...
      draw = function()
        ...
        love.graphics.printf("Please click on an option below to select.", 95, 15,500)
    ...
    freemode_menu={
      ...
      draw = function()
        ...
        love.graphics.setColor(255,255,255,255)
        love.graphics.setNewFont(ffontbold,24)
        love.graphics.printf("Song Select. Use the up and down arrow keys to navigate songs and hit return to select a song.", 95, 15,600)
...
--				end -- draws smaller image
    ...
    score_show={
      ...
      draw = function()
        ...
        love.graphics.setNewFont(ffontbold,64)
        love.graphics.printf("Final Score: " .. math.round(score,0), 100,200,9999)
      end,
      load = function()
    ...
    story_mode_select = {
      ...
      draw = function()
        ...
        love.graphics.draw(group1, 115, 110, 0, 0.9, 0.9)
        love.graphics.draw(group2, 471, 110, 0, 0.9, 0.9)
        love.graphics.draw(group3, 827, 110, 0, 0.9, 0.9)
        love.graphics.draw(group4, 115, 422, 0, 0.9, 0.9)
        love.graphics.draw(group5, 471, 422, 0, 0.9, 0.9)
        love.graphics.draw(group6, 827, 422, 0, 0.9, 0.9)
        love.graphics.setNewFont(ffontbold,24)
        love.graphics.printf("Story Select. Select a story group from the following options. You will then enter a sequence of songs.", 95, 15,1000)
