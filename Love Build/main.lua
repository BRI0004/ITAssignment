...
function love.draw()
  ...
  if game_dialog then
    ...
    if isDialogue then
      love.graphics.draw(transblack, 50, 768-200, 0, 24, 3, 0, 0, -0.02, 0)
      love.graphics.setNewFont(ffont, 32)
    ...
    function drawGameUI()
      ...
      love.graphics.print("BPM", 800,20)
      love.graphics.print("Length", 1000,20)
